...
- **React Router** : Gestion de la navigation entre les onglets Résultats et Prédictions.
...
- **MongoDB** : Base de données pour stocker les résultats et les paramètres de prédictions.